...
class Civ5FileReader(object):
    ...
    def bnw_terminated_string(self):
        s = ""
        flag = 0
        while flag < 3:
            c = self.r.read(1)
...
class Civ5Replay(Civ5FileReader):
    ...
    def read_header(self):
        ...
        print "Game: " + self.bnw_terminated_string() # civ5

        self.bnw_terminated_string()


        print "Version: " + self.bnw_terminated_string() # version


        print "Build?: " + self.bnw_terminated_string() # version


        print "Civ: " + self.bnw_terminated_string() 

        print "Difficulty Level: " + self.bnw_terminated_string() 

        print "Starting Era: " + self.bnw_terminated_string() 

        print "Ending? Era: " + self.bnw_terminated_string() 


        print "Game Speed: " + self.bnw_terminated_string() 


        print "World Size: " + self.bnw_terminated_string() 

        print "Map Script: " + self.bnw_terminated_string() 
